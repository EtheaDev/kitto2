...
AS
SELECT
ACTIVITY.ACTIVITY_ID EventId,
ACTIVITY.TYPE_ID CalendarId,
EMPLOYEE.employee_name ||' - '||PHASE.phase_name Title,
ACTIVITY.ACTIVITY_DATE+ACTIVITY.START_TIME StartDate,
ACTIVITY.ACTIVITY_DATE+ACTIVITY.END_TIME EndDate,
...
ACTIVITY.STATUS
FROM ACTIVITY
LEFT OUTER JOIN EMPLOYEE ON EMPLOYEE.employee_id = ACTIVITY.employee_id
LEFT OUTER JOIN PHASE ON PHASE.phase_id = ACTIVITY.phase_id
;
