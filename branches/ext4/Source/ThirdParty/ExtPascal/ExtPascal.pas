...
begin
  ...
  if not IsAjax then begin
    ...
    Response := IfThen(HTMLQuirksMode, '<!docttype html public><html>',
      ...
      // BEGIN EXTJS4
      '<script type="text/javascript" src="' + ExtPath + '/compatibility/ext3-core-compat.js"></script>'^M^J +
      '<script type="text/javascript" src="' + ExtPath + '/compatibility/ext3-compat.js"></script>'^M^J +
      // END EXTJS4
      ...
      '<img src="' + ExtPath + '/resources/themes/images/default/shared/loading-balls.gif"/>' +
      // END EXTJS4
