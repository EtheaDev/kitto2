...
function accept( const s: TSocket; addr: PSockAddr; addrlen: PLongint ): TSocket; overload; stdcall;external WINSOCK2_DLL name 'accept';
function accept( const s: TSocket; addr: PSockAddr; var addrlen: Longint ): TSocket; overload; stdcall;external WINSOCK2_DLL name 'accept';
function bind( const s: TSocket; addr: PSockAddr; const namelen: Longint ): Longint; overload; stdcall;external WINSOCK2_DLL name 'bind';
function bind( const s: TSocket; const addr: TSockAddr; namelen: Longint ): Longint; overload; stdcall;external WINSOCK2_DLL name 'bind';
function closesocket( const s: TSocket ): Longint; stdcall;external WINSOCK2_DLL name 'closesocket';
function connect( const s: TSocket; name: PSockAddr; namelen: Longint): Longint; overload; stdcall;external WINSOCK2_DLL name 'connect';
function connect( const s: TSocket; const name: TSockAddr; namelen: Longint): Longint; overload; stdcall;external WINSOCK2_DLL name 'connect';
function ioctlsocket( const s: TSocket; cmd: Longint; var arg: u_long ): Longint; overload; stdcall;external WINSOCK2_DLL name 'ioctlsocket';
function ioctlsocket( const s: TSocket; cmd: Longint; argp: pu_long ): Longint; overload; stdcall;external WINSOCK2_DLL name 'ioctlsocket';
...
//function getsockopt( const s: TSocket; const level, optname: Longint; optval: PChar; var optlen: Longint ): Longint; overload; stdcall;external WINSOCK2_DLL name 'getsockopt';
function getsockopt( const s: TSocket; const level, optname: Longint; optval: Pointer; var optlen: Longint ): Longint; overload; stdcall;external WINSOCK2_DLL name 'getsockopt';
//function getsockopt( const s: TSocket; const level, optname: Longint; var optval; var optlen: Longint ): Longint; overload; stdcall;external WINSOCK2_DLL name 'getsockopt';
...
//function recv(s: TSocket; var Buf; len, flags: Longint): Longint; overload; stdcall;external WINSOCK2_DLL name 'recv';
//function recv(s: TSocket; Buf: PChar; len, flags: Longint): Longint; overload; stdcall;external WINSOCK2_DLL name 'recv';
function recv(s: TSocket; Buf: Pointer; len, flags: Longint): Longint; overload; stdcall;external WINSOCK2_DLL name 'recv';
//function recvfrom(s: TSocket; Buf: PChar; len, flags: Longint; from: PSockAddr; fromlen: PLongint): Longint; overload; stdcall;external WINSOCK2_DLL name 'recvfrom';
...
//function recvfrom(s: TSocket; var Buf; len, flags: Longint; const from: TSockAddr; var fromlen: Longint): Longint; overload; stdcall;external WINSOCK2_DLL name 'recvfrom';
...
//function send(s: TSocket; const Buf; len, flags: Longint): Longint; overload; stdcall;external WINSOCK2_DLL name 'send';
//function send(s: TSocket; Buf: PChar; len, flags: Longint): Longint; overload; stdcall;external WINSOCK2_DLL name 'send';
function send(s: TSocket; Buf: Pointer; len, flags: Longint): Longint; overload; stdcall;external WINSOCK2_DLL name 'send';
function sendto(s: TSocket; const Buf; len, flags: Longint; const addrto: TSockAddr; tolen: Longint): Longint; overload; stdcall;external WINSOCK2_DLL name 'sendto';
//function sendto(s: TSocket; Buf: PChar; len, flags: Longint; addrto: PSockAddr; tolen: Longint): Longint; overload; stdcall;external WINSOCK2_DLL name 'sendto';
function sendto(s: TSocket; Buf: Pointer; len, flags: Longint; addrto: PSockAddr; tolen: Longint): Longint; overload; stdcall;external WINSOCK2_DLL name 'sendto';
//function setsockopt(s: TSocket; level, optname: Longint; const optval; optlen: Longint): Longint; overload; stdcall;external WINSOCK2_DLL name 'setsockopt';
//function setsockopt(s: TSocket; level, optname: Longint; optval: PChar; optlen: Longint): Longint; overload; stdcall;external WINSOCK2_DLL name 'setsockopt';
function setsockopt(s: TSocket; level, optname: Longint; optval: Pointer; optlen: Longint): Longint; overload; stdcall;external WINSOCK2_DLL name 'setsockopt';
